...
in
{
  options.services.moonlight-power = {
    enable = lib.mkEnableOption "controles de hardware y sesión de bajo consumo para Moonlight";
  };

  config = lib.mkIf config.services.moonlight-power.enable {
